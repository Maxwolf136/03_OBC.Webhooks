...
import { DiscordIntegration } from "./bim-components"
import { discordIntegrationUI } from "./bim-components"
...
const toolbar = BUI.Component.create(() => {
  return BUI.html`
    <bim-toolbar>
      ...
      ${discordIntegrationUI(world, components)}
    </bim-toolbar>
  `;
});
...
discordIntegration.setup({
  webhookURL: "https://discord.com/api/webhooks/1254534332706721973/Q0U4zYxreNYPU9l27CfbYoagJd4oD-EMQ8xif2GBCByme7JMdm9_UkgEagCqfBTCQZaf"
})
